...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        seekBarRed = findViewById(R.id.seekBar);
        seekBarGreen = findViewById(R.id.seekBar2);
        seekBarBlue = findViewById(R.id.seekBar3);
    ...
    protected void updatePreview() {
        ...
        captureRequestBuilder.set(CaptureRequest.COLOR_CORRECTION_GAINS,   new RggbChannelVector(red,green,green,blue));
        try {
